...
def generate_data():
    ...
    # Define a vector for our weights - note that these are the values
    # that we were given in our problem description
    w = [3, 2.5, -1]
...
weights: The assignment guidelines require that we experiment with
...
def gradient_descent(data, weights, epochs, batch_size, n, bias):
    ...
    for i in range(epochs):
        ...
        for j in range(batch_size):
            ...
            # for the gradient that is calculated.  Note that J
            # has been picked as this is the syntax we have from
            # our lecture notes
            J = 0
